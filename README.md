...
- 需求到实现的结构化收口
- 项目规则与个人偏好的分层管理
- 对官方 Flutter skills 的编排与项目内适配

这意味着 Flutter Forge 不是一个“Flutter 百科知识包”。
仓库中的工程规则、模板、反模式和调试手册只作为按需参考，不构成它的主价值。
...
- 老项目规则抽取
- 项目规则卡与记忆管理
- 官方 Flutter skills 委托与收口

## 辅助参考

以下内容属于辅助参考，而不是 Flutter Forge 的主身份：
