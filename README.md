...
| 小任务啰嗦一大堆，大任务反而没有设计过程 | 任务分级：小任务直接执行，大任务先走四角色设计流程 |
...
| 场景 | 加载的参考文档 |
|------|--------------|
| 老项目接入 | `legacy_project_scan.md`、`rule_card_template.yaml` |
...
| 场景 | 说什么 |
|------|--------|
| 老项目接入 | "这是一个老 Flutter 项目，先扫描结构再开发" |
...
│   ├── load_map.md                 # 场景 → 文档映射
│   ├── legacy_project_scan.md      # 老项目扫描协议
